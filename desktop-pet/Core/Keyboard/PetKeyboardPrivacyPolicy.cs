...
namespace PennyPet
{
    ...
    internal static class PetKeyboardPrivacyPolicy
    {
        ...
        internal static bool ShouldSuppressCapturedInput(
            bool automationPassword, bool standardPassword,
            bool knownCredentialWindow)
        {
            return ShouldSuppressCapturedInput(automationPassword,
                standardPassword, knownCredentialWindow, true);
        }

        internal static bool ShouldSuppressCapturedInput(
            bool automationPassword, bool standardPassword,
            bool knownCredentialWindow, bool inspectionAvailable)
        {
            // Fail closed: an unavailable inspector is itself sufficient to
            // suppress output from the global keyboard hook.
