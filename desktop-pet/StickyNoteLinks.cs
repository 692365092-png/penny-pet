...
namespace PennyPet
{
    ...
    // Detection is deliberately independent from the WPF editor.  The editor
    // only applies presentation formatting after IME composition has ended;
    // it never replaces text or changes the user's composition string.
