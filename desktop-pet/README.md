...
对话气泡使用 `RGB(73, 74, 40)` 绿色和白色粗体。普通对话、悬停气泡和到点提醒统一跟随“按键文字”设置；提醒对话框里的字号只控制便利贴内部的倒计时显示。到点提醒会一直显示，必须点击气泡本身才会关闭，后续功能提示或新提醒可以覆盖它。

待办、日程和提醒倒计时使用五档字号：特小 9、小 10.5、中 16、大 22、特大 48。普通便利贴仍保留完整的传统字号列表。

右键菜单中的“将已展开的便利贴集中到此屏幕”按小 Penny 所在显示器的 DPI 进行布局；普通便利贴、待办、日程和整个磁吸组合都会集中到屏幕中央，较长或较宽的组合独立排在下方。
