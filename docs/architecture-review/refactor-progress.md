...
Production rendering therefore remains unchanged. The next CI run intentionally repeats the same observational probe; R19 closes without renderer changes unless a repeatable material difference appears.
